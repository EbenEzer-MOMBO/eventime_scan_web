...
export default function TicketAlreadyValidatedPage() {
    ...
    <div className="min-h-screen bg-[#8BC34A] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-8">
        ...
        <div className="w-full max-w-xl bg-[#E8E8E8] rounded-3xl shadow-2xl p-8 flex flex-col items-center">
          ...
          {/* Message d'erreur */}
          <h1 className="text-2xl font-bold text-red-500 text-center mb-8">
            Le ticket est déjà validé
          </h1>
          ...
          <div className="w-full bg-white rounded-2xl shadow-md p-6 mb-8 space-y-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-black font-bold text-lg">ticket_164.EBEN</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-black font-bold text-lg">M. EBEN MOMBO</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-black font-bold text-lg break-all">ebenezermombo@gmail.com</p>
              </div>
            </div>
      ...
      {/* Barre rouge en bas */}
      <div className="bg-red-500 text-white text-center py-6 font-bold text-xl">
        Le ticket est déjà validé
      </div>
    </div>
  );

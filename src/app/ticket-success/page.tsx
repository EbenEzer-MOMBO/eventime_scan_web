          ...
          <div className="w-full bg-white rounded-2xl shadow-md p-6 mb-8 space-y-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-black font-bold text-lg">ticket_598.MOMBO</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-black font-bold text-lg">M. MOMBO Eben</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-black font-bold text-lg break-all">ebenezermombo@icloud.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-black font-bold text-lg">En attente</p>
              </div>
            </div>
          </div>
